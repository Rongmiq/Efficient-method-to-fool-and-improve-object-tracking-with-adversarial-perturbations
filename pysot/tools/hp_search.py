...
parser.add_argument('--snapshot', type=str, default='/home/marq/Desktop/CSA/pysot/experiments/siamcar_r50/model.pth', help='snapshot of model')
parser.add_argument('--dataset', type=str, default='VOT2018', help='dataset name to eval')
...
if __name__ == '__main__':
    ...
    dataset_root = os.path.join(cur_dir, '/home/marq/Desktop/datasets', args.dataset)
    ...
    # create model
    model = ModelBuilder('siamcar_otb')
