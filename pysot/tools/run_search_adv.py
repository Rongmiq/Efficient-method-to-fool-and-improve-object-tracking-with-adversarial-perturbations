...
def main():
    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if idx == frame_counter:
                    ...
                    if args.adv:
                        if 'car' in args.tracker_name:
                            outputs = tracker.track_adv(img,GAN_1,hp,save_path=args.save_path,frame_id=idx)
                        else:
                            outputs = tracker.track_adv(img,GAN_1,save_path=args.save_path,frame_id=idx)
                    else:
                        if 'car' in args.tracker_name:
        ...
        # OPE tracking
        for v_idx, video in enumerate(dataset):
            model_path = os.path.join('results', args.dataset, model_name + args.tracker_name)
