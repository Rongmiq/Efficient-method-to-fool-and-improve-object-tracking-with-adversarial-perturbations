...
class OTB(object):
    ...
    #                 'Jogging','Jogging-1', 'Jogging-2',  'KiteSurf', 'Lemming', 'Man', 'Mhyang',
    #                 'MountainBike', 'Rubik', 'Singer1', 'Skater',
    #                 'Skater2', 'Subway', 'Suv', 'Tiger1', 'Toy', 'Trans',
    #                 'Twinnings', 'Vase'] + __tb50_seqs

    __tb100_seqs = ['Basketball', 'Biker', 'Bird1', 'Bird2', 'BlurBody', 'BlurCar1',
                    ...
                    'Crossing', 'Crowds', 'Dancer', 'Dancer2', 'David', 'David2',
                    'David3', 'Deer', 'Diving', 'Dog', 'Dog1', 'Doll', 'DragonBaby',
                    'Dudek', 'FaceOcc1', 'FaceOcc2', 'Fish', 'FleetFace', 'Football',
                    'Football1', 'Freeman1', 'Freeman3', 'Freeman4', 'Girl', 'Girl2',
                    'Gym', 'Human2', 'Human3', 'Human4-2', 'Human5', 'Human6', 'Human7',
                    'Human8', 'Human9', 'Ironman', 'Jogging-1', 'Jogging-2', 'Jump',
                    'Jumping', 'KiteSurf', 'Lemming', 'Liquor', 'Man', 'Matrix',
                    'Mhyang', 'MotorRolling', 'MountainBike', 'Panda', 'RedTeam',
                    'Rubik', 'Shaking', 'Singer1', 'Singer2', 'Skater', 'Skater2',
                    'Skating1', 'Skating2-1', 'Skating2-2', 'Skiing', 'Soccer',
                    'Subway', 'Surfer', 'Suv', 'Sylvester', 'Tiger1', 'Tiger2',
                    'Toy', 'Trans', 'Trellis', 'Twinnings', 'Vase', 'Walking',
                    'Walking2', 'Woman']
