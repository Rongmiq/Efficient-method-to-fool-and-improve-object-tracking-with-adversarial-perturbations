...
if __name__ == '__main__':
    ...
    ''' create dataset'''
    dataset = GOT10k_dataset(max_num=10)
    ...
    for epoch in range(opt.epoch_count, opt.epoch_count + opt.epochs):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
