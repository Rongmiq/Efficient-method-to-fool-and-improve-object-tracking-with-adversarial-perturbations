...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='trdimp', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='trdimp_lasot', help='Name of parameter file.')
