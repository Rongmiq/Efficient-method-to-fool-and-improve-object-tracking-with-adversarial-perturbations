...
from got10k.experiments import ExperimentLaSOT
import numpy as np
import os
import sys
import argparse
...
parser = argparse.ArgumentParser(description='Run LaSOT.')
parser.add_argument('--tracker_name', type=str, default='trdimp')
parser.add_argument('--tracker_param', type=str, default='trdimp_lasot')  # trsiam_vot / trdimp_vot
...
if __name__ == '__main__':
    ...
    experiment = ExperimentLaSOT('/home/marq/Desktop/datasets/LaSOT',subset='test')
    # experiment.run(tracker, visualize=False)

    # report performance
    # print(tracker.name)
    trackers = os.listdir('/home/marq/Desktop/CSA/pytracking/results/LaSOT')
    print(trackers)
    experiment.report([trackers[0]])
