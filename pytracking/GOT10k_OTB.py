...
parser = argparse.ArgumentParser(description='Run OTB.')
parser.add_argument('--tracker_name', type=str, default='trdimp')
parser.add_argument('--tracker_param', type=str, default='trdimp')  # trsiam_vot / trdimp_vot
...
if __name__ == '__main__':
    ...
    experiment = ExperimentOTB('/home/marq/Desktop/datasets/OTB2015', version=2015)
    # experiment.run(tracker, visualize=False)

    # report performance
    # experiment.report([tracker.name])

    trackers = os.listdir('/home/marq/Desktop/CSA/pysot/results/OTB2015')
    print(trackers)
