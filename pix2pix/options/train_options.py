...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # train setting
        parser.add_argument('--dataset', default='mot', type=str,help='dataset for training')
        parser.add_argument('--epochs', default=25, type=int, help='epochs')
        parser.add_argument('--num_workers', '-n', default=4, type=int, help='number of thread to load data')
