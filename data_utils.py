...
class GOT10k_dataset(Dataset):
    def __init__(self, max_num=15):
        ...
        fp = open(r'/home/marq/Desktop/CSA/gt.txt')
        for line in fp:
            line = line.split('\n')
            self.gt.append(line)
    ...
    def __getitem__(self, index):
        ...
        '''get init frame groundtruth tensor'''
        gt = self.gt[index][0]
        ...
        box[0] = (gt[:split_index[0]])
        box[1] = (gt[split_index[0] + 1: split_index[1]])
        box[2] = (gt[split_index[1] + 1: split_index[2]])
        box[3] = (gt[split_index[2] + 1:])
        ...
        return (init_tensor, search_tensor, box, index)
    def __len__(self):
